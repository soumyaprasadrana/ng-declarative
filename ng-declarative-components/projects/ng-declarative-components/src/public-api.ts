/*
 * Public API Surface of ng-declarative-components
 */

export * from "./lib/ng-declarative-components.service";
export * from "./lib/ng-declarative-components.component";
export * from "./lib/ng-declarative-components-label.component";
export * from "./lib/ng-declarative-components-image.component";
export * from "./lib/ng-declarative-components-paragraph.component";
export * from "./lib/ng-declarative-components-auth-controller";
export * from "./lib/ng-declarative-components-form.component";
export * from "./lib/ng-declarative-components-slideshow.component";
...
export * from "./lib/ng-declarative-components-button.component";
export * from "./lib/ng-declarative-components-foldable-blocks.component";
export * from "./lib/ng-declarative-components-route.component";
export * from "./lib/ng-declarative-components-link.component";
export * from "./lib/ng-declarative-components-base.component";
